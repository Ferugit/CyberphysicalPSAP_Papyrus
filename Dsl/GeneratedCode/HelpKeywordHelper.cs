...
namespace UPM.IoT_DSL_AF2
{
	...
	/// </remarks>
	public partial class IoT_DSL_AF2HelpKeywordHelper : IoT_DSL_AF2HelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new IoT_DSL_AF2HelpKeywordHelper.
		/// </summary>
		protected IoT_DSL_AF2HelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the IoT_DSL_AF2HelpKeywordHelper.
		/// </summary>
		public static IoT_DSL_AF2HelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class IoT_DSL_AF2HelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new IoT_DSL_AF2HelpKeywordHelperBase.
		/// </summary>
		protected IoT_DSL_AF2HelpKeywordHelperBase()
			: base() { }
