...
namespace UPM.IoT_DSL_AF2
{
	...
	/// </summary>
	internal partial class IoT_DSL_AF2CommandSet : IoT_DSL_AF2CommandSetBase
	{
		/// <summary>
		/// Constructs a new IoT_DSL_AF2CommandSet.
		/// </summary>
		public IoT_DSL_AF2CommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class IoT_DSL_AF2CommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new IoT_DSL_AF2CommandSetBase.
		/// </summary>
		protected IoT_DSL_AF2CommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewIoT_DSL_AF2ExplorerCommand,
				typeof(IoT_DSL_AF2EditorFactory).GUID);
		...
		{
			IoT_DSL_AF2ExplorerToolWindow explorer = this.IoT_DSL_AF2ExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected IoT_DSL_AF2DocData CurrentIoT_DSL_AF2DocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as IoT_DSL_AF2DocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected IoT_DSL_AF2DocView CurrentIoT_DSL_AF2DocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as IoT_DSL_AF2DocView;
			}
		}
		...
		/// </summary>
		protected IoT_DSL_AF2ExplorerToolWindow IoT_DSL_AF2ExplorerToolWindow
		{
			get
			{
				IoT_DSL_AF2ExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(IoT_DSL_AF2ExplorerToolWindow), true) as IoT_DSL_AF2ExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				IoT_DSL_AF2ExplorerToolWindow explorerWindow = this.IoT_DSL_AF2ExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class IoT_DSL_AF2ClipboardCommandSet : IoT_DSL_AF2ClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new IoT_DSL_AF2ClipboardCommandSet.
		/// </summary>
		public IoT_DSL_AF2ClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class IoT_DSL_AF2ClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new IoT_DSL_AF2ClipboardCommandSetBase.
		/// </summary>
		protected IoT_DSL_AF2ClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
